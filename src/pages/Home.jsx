    ...
    return (
        <div className='md:w-3/4 min-h-screen pt-16 mx-auto flex flex-col justify-center items-center md:flex-row'>
            <div className='px-3 text-center md:text-left'>
                <div className=''>
                    <span className='font-medium text-[22px] md:text-2xl xl:text-3xl text-slate-400'>luma</span>
                    <h1 className='w-4/5 mx-auto md:w-3/4 md:mx-0 my-1 font-semibold text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-white'>Delightful events {' '}
                ...
                <p className='mt-2 text-slate-200 text-base md:w-4/5 lg:text-xl lg:my-4'>Set up an event page, invite friends and sell tickets. Host a memorable event today.</p>
                <button className='my-4 px-4 py-1 lg:px-6 lg:py-2 lg:font-medium bg-white border-none hover:bg-slate-700 hover:text-white rounded-lg'>Create Your First Event</button>
            </div>
