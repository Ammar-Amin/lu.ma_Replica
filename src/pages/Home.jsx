...
export default function Home() {
    return (
        <div className='md:w-3/4 pt-16 mx-auto flex flex-col justify-center items-center md:flex-row'>
            <div className='px-3 text-center md:text-left'>
                ...
                <p className='mt-2 text-slate-200 text-sm md:text-base'>Set up an event page, invite friends and sell tickets. Host a memorable event today.</p>
                <button className='my-4 px-4 py-1 lg:font-medium bg-white border-none rounded-lg'>Create Your First Event</button>
            </div>
            <div className='mt-4 mb-8 w-[320px] md:w-full rounded-full'>
